...
int main(void)
{
    ...
    rlImGuiSetup(true);
    SetTargetFPS(60);
    const float duration = 1.0f;    // time it takes to get from current cell to next cell
    ...
    float rotation = 0.0f;             // Current rotation of the agent
    ...
    {
        // Task 1: interpolate along the path generated by A* instead of my test path
